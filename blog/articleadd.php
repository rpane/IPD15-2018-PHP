...
MARKER;
            ...
            if (isset($_POST['title'])) { // State 2 or 3 - receiving submission
                ...
                if ($errorList) { // state 3: errors
                    ...
                    $query = sprintf("INSERT INTO articles VALUES (NULL, '%s', NULL, '%s', '%s')", mysqli_real_escape_string($link, $userid), mysqli_real_escape_string($link, $title), mysqli_real_escape_string($link, $body));
